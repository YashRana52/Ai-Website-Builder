...
function Sidebar({
  ...
  // Submit a revision / request change
  const handleRevision = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.error(
        error?.response?.data?.message || "Failed to submit revision"
      );
    } finally {
  ...
  // Scroll to bottom on new message or generation
  useEffect(() => {
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar px-3 flex flex-col gap-4">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <EyeIcon className="size-6 p-1 bg-gray-600 hover:bg-gray-500 transition-colors rounded" />
                      </Link>
                    </div>
                  </div>
                );
          ...
          {isGenerating && (
            <div className="flex items-start gap-3 justify-start">
              <div className="w-8 h-8 rounded-full justify-center flex items-center bg-linear-to-br from-indigo-600 to-indigo-700 ">
